                    ...
                    <div className={toggleState === 1 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                I create responsive, user-friendly, and interactive interfaces
                                using Angular, Ionic, HTML, CSS, and JavaScript/TypeScript.
                            </p>
                    ...
                    <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                ...
                                with Node.js, Express, Spring Boot, MongoDB, and SQL.
                            </p>
                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                I deliver complete web solutions by integrating modern
                                frontend and backend technologies for robust applications.
                            </p>
